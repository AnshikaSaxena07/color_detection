'''NAME : ANSHIKA SAXENA
PROJECT : COLOR IDENTIFICATION IN IMAGE
...
#create a function name mouseRGB
...
def mouseRGB(event,x,y,flags,param):
    if event == cv2.EVENT_LBUTTONDOWN:
        ...
        if colorsR==165 and colorsG==42 and colorsB==42:
            img2 = cv2.rectangle(image, (10, 10), (330, 150), (0, 0, 0), -1)
            img5 = cv2.putText(image, 'BROWN', (10, 100), font, 2, (255, 255, 255), 4, cv2.LINE_AA)
        ...
        if colorsR==181 and colorsG==230 and colorsB==29:
            img2 = cv2.rectangle(image, (10, 10), (330, 150), (0, 0, 0), -1)
            img5 = cv2.putText(image, 'LIGHT GREEN', (10, 100), font, 2, (255, 255, 255), 4, cv2.LINE_AA)
        ...
        if colorsR==34 and colorsG==177 and colorsB==76:
            img2 = cv2.rectangle(image, (10, 10), (330, 150), (0, 0, 0), -1)
            img5 = cv2.putText(image, 'DARK GREEN', (10, 100), font, 2, (255, 255, 255), 4, cv2.LINE_AA)
